...
description: "The standard end-user license agreement for all EFBox packages."
summary: "The standard end-user license agreement for all EFBox packages."
draft: false
images: []
type: "legal"
---
...
11. MISCELLANEOUS
The license herein pertains solely to the Software version acquired under this Agreement. Licenses for previous or subsequent versions are governed by the agreements accompanying those versions. You commit to adhering to all relevant laws and regulations concerning the Software, including, but not limited to, export and re-export control laws.
